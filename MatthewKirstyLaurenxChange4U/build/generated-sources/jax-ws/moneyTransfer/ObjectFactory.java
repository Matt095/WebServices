 ...
 * generated in the moneyTransfer package. 
...
public class ObjectFactory {
    ...
    private final static QName _TransferResponse_QNAME = new QName("http://webservices/", "transferResponse");
    private final static QName _Transfer_QNAME = new QName("http://webservices/", "transfer");

    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: moneyTransfer
     * 
     */
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://webservices/", name = "transferResponse")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://webservices/", name = "transfer")
